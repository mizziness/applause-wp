...
class LWP_PostCarouselModule extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		$categories_select =array(
			'all' => esc_html__( 'All Categories', 'lwp-divi-module' ),
		);

		foreach($categories_array as $categories_item)
			$categories_select =	array_merge($categories_select,array(
				$categories_item->slug => $categories_item->name
				)
			);

		$post_fields_paid = array(
			'order' => array(
				'label'           => esc_html__( 'Order', 'lwp-divi-module' ),
				'description'     => esc_html__( 'Choose the order for the posts', 'lwp-divi-module' ),
				'type'            => 'select',
				'option_category' => 'basic_option',				
				'options'         => array(
					'ASC'				 			=> esc_html__( 'Ascending ', 'lwp-divi-module' ),
					'DESC' 							=> esc_html__( 'Descending ', 'lwp-divi-module' ),
				),
				'default'=> 'DESC',
				'toggle_slug'      => 'content_settings',					
			),
			'orderby' => array(
				'label'           => esc_html__( 'Order By', 'lwp-divi-module' ),
				'description'     => esc_html__( 'Choose parameter to sort retrieved posts', 'lwp-divi-module' ),
				'type'            => 'select',
				'option_category' => 'basic_option',				
				'options'         => array(
					'date'				 			=> esc_html__( 'Date ', 'lwp-divi-module' ),
					'modified' 						=> esc_html__( 'Last Modified ', 'lwp-divi-module' ),
					'title' 						=> esc_html__( 'Title ', 'lwp-divi-module' ),
					'name' 							=> esc_html__( 'Post Slug ', 'lwp-divi-module' ),
					'rand' 							=> esc_html__( 'Random ', 'lwp-divi-module' ),
					'comment_count' 				=> esc_html__( 'Comment Count ', 'lwp-divi-module' ),
					'author' 						=> esc_html__( 'Author', 'lwp-divi-module' ),
					'ID' 							=> esc_html__( 'ID ', 'lwp-divi-module' ),
					'menu_order' 					=> esc_html__( 'Menu Order ', 'lwp-divi-module' ),
				),
				'default'=> 'date',
				'toggle_slug'      => 'content_settings',					
			),									
			'post_offset' => array(
				'label'            => esc_html__( 'Post offset', 'lwp-divi-module' ),
				'description'      => esc_html__( 'Choose the offset for posts', 'lwp-divi-module' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'content_settings',
				'default'		   => '0',	
			...
			'excerpt_length' => array(
				'label'            => esc_html__( 'Excerpt Length', 'lwp-divi-module' ),
				'description'      => esc_html__( 'Set the length of excerpt in characters.', 'lwp-divi-module' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'content_settings',
				'default'		   => '170',	
			...
			'date_format' => array(
				'label'            => esc_html__( 'Date Format', 'lwp-divi-module' ),
				'description'      => esc_html__( 'If you would like to adjust the date format, input the appropriate date format here.', 'lwp-divi-module' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'content_settings',
				'default'		   => 'M j, Y',	
			...
			'button_text' => array(
				'label'            => esc_html__( 'Button Text', 'lwp-divi-module' ),
				'description'      => esc_html__( 'Set the text for button', 'lwp-divi-module' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'content_settings',
				'default'		   => 'Read More',	
			...
			'show_title' => array(
				'label'           => esc_html__( 'Show Title', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show Title for the posts', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_featured_image' => array(
				'label'           => esc_html__( 'Show Featured Image', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show featured image for the posts', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_excerpt' => array(
				'label'           => esc_html__( 'Show Excerpt', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show Excerpt for the posts', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_author' => array(
				'label'           => esc_html__( 'Show Author', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show Author in post meta', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_date' => array(
				'label'           => esc_html__( 'Show Date', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show Date in post meta', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_categories' => array(
				'label'           => esc_html__( 'Show Categories', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show Categories in post meta', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_comments' => array(
				'label'           => esc_html__( 'Show Comments', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show comment count in post meta', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'show_button' => array(
				'label'           => esc_html__( 'Show Button', 'lwp-divi-module' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'description' => esc_html__('Select if you want to show read more button', 'lwp-divi-module'),
				'toggle_slug'     => 'element_settings',
				'options'         => array(
					'off' => esc_html__( 'No', 'lwp-divi-module' ),
					'on'  => esc_html__( 'Yes', 'lwp-divi-module' ),
			...
			'carousel_style' => array(
				'label'           => esc_html__( 'Style', 'lwp-divi-module' ),
				'description'     => esc_html__( 'Choose the style for the carousel.', 'lwp-divi-module' ),
				'type'            => 'select',
				'option_category' => 'basic_option',				
				'options'         => array(
					'default' 	  		=> esc_html__( 'Default', 'lwp-divi-module' ),
					'side' 				=> esc_html__( 'Side Image', 'lwp-divi-module' ),
					'overlay' 			=> esc_html__( 'Overlay Content', 'lwp-divi-module' ),
					'hover' 			=> esc_html__( 'Hover Content', 'lwp-divi-module' ),
					'overlay_box' 		=> esc_html__( 'Overlay Box', 'lwp-divi-module' ),
					'overlap_content' 	=> esc_html__( 'Overlap Content', 'lwp-divi-module' ),
				),
				'default'			=> 'default',
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',
			...
			'carousel_image_position' => array(
				'label'           => esc_html__( 'Image Position', 'lwp-divi-module' ),
				'description'     => esc_html__( 'Choose the image position for the carousel.', 'lwp-divi-module' ),
				'type'            => 'select',
				'option_category' => 'basic_option',				
				'options'         => array(
					'left' 	  		=> esc_html__( 'Left', 'lwp-divi-module' ),
			...
			'overlay_content_color' => array(
				'label'           	=> esc_html__( 'Overlay Color', 'lwp-divi-module' ),
				'type'            	=> 'color-alpha',
				'description' 		=> esc_html__('Select the  color for the overlay in the carousel.', 'lwp-divi-module'),
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',
				'show_if'     => array(
					'carousel_style' 		=> array( 'overlay', 'hover','overlay_box'),
				),				
			),
			'hover_transition_speed' => array(
				'label'           => esc_html__( 'Transition Speed (in ms)', 'lwp-divi-module' ),
				'description'     => esc_html__( 'Set the transition speed for hover animation', 'lwp-divi-module' ),
				'type'              => 'range',
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',				
				'option_category'   => 'basic_option',
			...
			'overlay_padding' => array(
				'label'           	=> esc_html__( 'Overlay Padding', 'lwp-divi-module' ),
				'type'            	=> 'custom_padding',
				'description' 		=> esc_html__('Set the padding around the overlay.', 'lwp-divi-module'),
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',
				'show_if'     => array(
					'carousel_style' 		=> 'overlay_box',
				),
			),
			'content_padding' => array(
				'label'           	=> esc_html__( 'Content Padding', 'lwp-divi-module' ),
				'type'            	=> 'custom_padding',
				'description' 		=> esc_html__('Set the padding inside the content box.', 'lwp-divi-module'),
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',
				'show_if'     => array(
					'carousel_style' 		=> 'overlay_box',
			...
			'content_margin' => array(
				'label'           	=> esc_html__( 'Content Margin', 'lwp-divi-module' ),
				'type'            	=> 'custom_margin',
				'description' 		=> esc_html__('Set the margins for the content box.', 'lwp-divi-module'),
				'toggle_slug'     	=> 'layout',
				'tab_slug'          => 'advanced',
				'show_if'     => array(
					'carousel_style' 		=> 'overlap_content',
				),
			),																																				
		);
		}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if(lwp_pcdivi_fs()->is__premium_only()){
			...
			$carousel_image_position 		= $this->props['carousel_image_position'];
			$overlay_content_color	 		= $this->props['overlay_content_color'];
			$hover_transition_speed	 		= $this->props['hover_transition_speed'];
			$overlay_padding	 			= $this->props['overlay_padding'];
			$content_padding	 			= $this->props['content_padding'];
			$content_margin	 				= $this->props['content_margin'];
		...
		while ( $post_query->have_posts() ) {
			...
			if($show_excerpt == 'on'){
				...
				if(has_excerpt() && $use_manual_excerpt =='on'){
					...
					$excerpt_text	= et_core_intentionally_unescaped( wpautop( et_delete_post_first_video( strip_shortcodes( truncate_post( $excerpt_length, false, '', true ) ) ) ), 'html' );  
				}
		...
		if(isset($arrow_bg)){
			...
			et_pb_responsive_options()->generate_responsive_css( $arrow_bg_values, '%%order_class%% .slick-next:before,%%order_class%% .slick-prev:before', 'background-color', $render_slug,'','color');
		}
		...
		if(isset($dots_color)){
		  ...
		  return sprintf( 
			...
			<section class="lwp-slick-slider slider small-slider %4$s" %2$s>
				%1$s
			</section>',$post_output,$data_slick,$sync_slider_html,$helper_class);
