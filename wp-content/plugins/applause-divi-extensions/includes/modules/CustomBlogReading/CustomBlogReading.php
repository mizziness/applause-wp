 ...
 * @since 1.0.0
 */
class DICM_BLOG_READING_TIME extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'dicm_blog_reading_time';
	...
	function init() {
		// Module name
		$this->name             = esc_html__( 'Blog Reading Time', 'dicm-divi-custom-modules' );
