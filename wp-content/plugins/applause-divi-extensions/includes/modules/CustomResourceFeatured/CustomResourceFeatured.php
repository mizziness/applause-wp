 ...
 * @since 1.0.0
 */
class DICM_RESOURCE_FEATURED extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'dicm_resource_featured';
	...
	function init() {
		// Module name
		$this->name             = esc_html__( 'Applause Resources', 'dicm-divi-custom-modules' );
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		if( !empty( $post_in_from  ) ) {
			...
			$args = array(
				...
				'post_type' => array('case_studies', 'ebooks', 'webinars', 'reports'),
