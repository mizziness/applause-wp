    ...
    class DE_DF_LICENSE
        {
            ...
            public static function get_licence_data()
                {
                    ...
                    $license_data = get_option('divi_daf_license');
            ...
            public static function update_licence_data( $license_data )
                {
                    ...
                    update_option('divi_daf_license', $license_data);
            ...
            function is_local_instance()
                {
                    return FALSE;
                    $instance   =   trailingslashit(DE_DF_INSTANCE);
                    if(
