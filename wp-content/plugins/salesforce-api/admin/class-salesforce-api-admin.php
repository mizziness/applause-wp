 ...
 * @subpackage Salesforce_Api/admin
 */
...
class Salesforce_Api_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/salesforce-api-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/salesforce-api-admin.js', array( 'jquery' ), $this->version, false );
	...
	// /**
	//  * Get form submission data for Salesforce lead parsing
	//  *
	//  * @param [type] $entry
	//  * @param [type] $form
	//  * @return void
	//  */
	// public function afterSalesforceSubmission( $entry, $form ) {

	// 	$fields = [
	// 		'firstName'				=> $_POST['input_24'],
	// 		'lastName'				=> $_POST['input_25'],
	// 		'title' 				=> $_POST['input_16'],
	// 		'company'				=> $_POST['input_17'],
	// 		'of_Employees__c'		=> $_POST['input_18'],
	// 		'email'					=> $_POST['input_19'],
	// 		'phone'					=> $_POST['input_20'],
	// 		'country'				=> $_POST['input_21'],
	// 		'marketingLeadNotes'	=> $_POST['input_22'],
	// 		'comments'				=> $_POST['input_23'],
	...
	// 	global $wpdb;
	// 	$table_name = $wpdb->prefix . 'salesforce_jobs';
	...
	// 		'label' => 'Intentions',
	// 		'description' => 'Choose the "intention" you want to be passed to Salesforce as the indicator of the action the user took.',
	// 		'choices'    => array(
	// 			array(
	...
	// /**
	//  * Checks the salesforce job table for any jobs that have not been 
	//  * run yet and processes them
	//  *
	//  * @return void
	//  */
	// public function sendSalesforceData() {
	// 	global $wpdb;
	// 	$table_name = $wpdb->prefix . 'salesforce_jobs';
	// 	$host = getenv('SALESFORCE_HOST_KEY');
	...
	// 				"Salesforce API Failure - Create Lead",
	...
	// 			wp_mail(
	// 				'tshipps@applause.com',
	// 				"Salesforce API Failure - Associate Lead",
	...
	// 		$host 			= getenv('SALESFORCE_HOST_KEY');
	// 		$customActivity = getenv('SALESFORCE_CUSTOM_ACTIVITY_TYPE_ID');
	...
	// 			wp_mail(
	// 				'tshipps@applause.com',
	// 				"Salesforce API Failure - Activity",
	...
	// /**
	//  * Generates a token for Salesforce's API
	//  *
	//  * @return void
	//  */
    // public function newToken()
    // {
	// 	GFCommon::log_debug( "==>> Getting a new Salesforce Token") ;
	...
	// 			wp_mail(
	// 				'tshipps@applause.com',
	// 				"Salesforce API Failure - Token",
	// 				"We tried to get a token from the Salesforce API but it failed to return a token."
	// 			);
	// 		// }
	// 	}
    ...
    //             GFCommon::log_debug("Lead #" . $res['leadId'] . " returned from the Salesforce API!");
    //         }
    //         $responseData =  $res;
	...
	// /**
    //  * Add activity to Salesforce Lead
    //  *
    //  * @param $host             Hostname
    //  * @param $activityTypeId   Activity ID type from Salesforce
