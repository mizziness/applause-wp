...
?>
	...
	<!-- OneTrust Cookies Consent Notice start for applause.com -->
		<script>
		...
		<?php 
			$scriptID = "1a88cc13-3481-459b-850e-42e587047549";
			if ( getenv("environment") == "development" ) {
				$scriptID = $scriptID . "-test";
			}
		?>

		<script src="https://cdn.cookielaw.org/scripttemplates/otSDKStub.js"  type="text/javascript" charset="UTF-8" data-domain-script="<?php echo $scriptID; ?>" ></script>

		<script type="text/javascript">
			function OptanonWrapper() { }
		</script>
	<!-- OneTrust Cookies Consent Notice end for applause.com -->
