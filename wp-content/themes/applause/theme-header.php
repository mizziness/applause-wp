...
<?php ob_start(); ?>
	<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
		...
		<div id="mega-menu-dropdowns" class="container" contenteditable="false">

			<div id="why_applause" class="mega-nav-dropdown"><?php echo do_shortcode( '[divi_library_shortcode id="43944"]' ); ?></div>
			<div id="our_solutions" class="mega-nav-dropdown"><?php echo do_shortcode( '[divi_library_shortcode id="44679"]' ); ?></div>
			<div id="about_us" class="mega-nav-dropdown"><?php echo do_shortcode( '[divi_library_shortcode id="44561"]' ); ?></div>
			<div id="resources" class="mega-nav-dropdown"><?php echo do_shortcode( '[divi_library_shortcode id="44627"]' ); ?></div>
